...
ALL_SETTINGS = [  # [名称, 默认值, 是否在尝试修复时重置, 简介]
    ...
    ["INIT", "2", False, "初始化标识"],
    ["QEXO_ICON", "https://unpkg.com/qexo-static@2.1.4/qexo/images/icon.png", False, "站点ICON"],
    ["QEXO_LOGO", "https://unpkg.com/qexo-static@2.1.4/qexo/images/qexo.png", False, "站点LOGO"],
    ["QEXO_LOGO_DARK", "https://unpkg.com/qexo-static@2.1.4/qexo/images/qexo-dark.png", False, "暗色站点LOGO"],
