...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "CONFIRM_DEL_CUSTOM": "Are you sure you want to delete the {} field? This operation is irreversible",
            ...
            "CONFIRM_RUN": "Are you sure you want to run {}? This operation cannot be aborted",
            "CONSOLE": "Console",
            "CONTENT": "Content",
