...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "SET_SECURE_5": "Login Page cf-turnstile Site Key",
            "SET_SECURE_5_PH": "Leave blank to disable this feature",
            "SET_SECURE_6": "Login Page cf-turnstile Secret Key",
            "SET_SECURE_6_PH": "Leave blank to disable this feature",
            ...
            "WEBHOOK_APIKEY_EXISTS": "APIKEY already exists, please delete it first",
            "WEBHOOK_CREATE_SUCCESS": "Webhook Created Successfully!",
            "WEBHOOK_NOT_SUPPORT": "Platform does not support Webhook or an error occurred",
            "WELCOME": "Welcome",
            ...
            "PASSKEY_DELETE_CONFIRM": "Are you sure you want to delete the Passkey device {}? You will not be able to use this device to sign in after deletion",
            ...
            "PASSKEY_TIP_BROWSERS": "Works best on modern browsers that support WebAuthn",
            "PASSKEY_TIP_PLATFORM_AUTHENTICATOR": "Some platforms only support platform authenticators (e.g., fingerprint/Face ID)",
            "PASSKEY_TIP_FALLBACK_PASSWORD": "If unsupported, you can still sign in with username and password",
            "PASSKEY_TIP_LOST_REMOVE": "If a device is lost, please remove the corresponding Passkey promptly",
            "DELETE": "Delete",
            "DELETING": "Deleting...",
