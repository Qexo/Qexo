...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "PUBLISH_CONFIRM_1": "Êtes-vous sûr de vouloir publier",
            "PUBLISH_CONFIRM_2": " ?",
            "UNPUBLISH_CONFIRM_1": "Êtes-vous sûr de vouloir annuler la publication",
            "UNPUBLISH_CONFIRM_2": " ?",
            ...
            "EXCERPT_CHATGPT_API_KEY": "Clé API ChatGPT",
            "EXCERPT_CHATGPT_API_KEY_PH": "Entrez votre clé API ChatGPT",
            "EXCERPT_CHATGPT_LENGTH": "Longueur envoyée",
            "EXCERPT_CHATGPT_LENGTH_PH": "Longueur du texte envoyé au serveur",
            "EXCERPT_CHATGPT_MODEL": "Modèle",
            "EXCERPT_CHATGPT_MODEL_PH": "Par exemple : text-davinci-003",
            "EXCERPT_CHATGPT_API": "URL API ChatGPT",
            "EXCERPT_CHATGPT_API_PH": "Entrez l'URL de l'API ChatGPT",
            "EXPORT": "Exporter",
            ...
            "INIT": "Initialisation",
            "INIT_LANGUAGE_INVALID": "Langue invalide, veuillez choisir une langue prise en charge",
            "INIT_2_1": "Clé API",
            ...
            "PROVIDER_REQUIRED": "Veuillez choisir un fournisseur",
            ...
            "NEW": "Nouveau",
            "NEW_PH": "le fichier sera enregistré sous",
            "NEXT": "Suivant",
            ...
            "UNPUBLISH_SUCCESS": "Publication annulée avec succès !",
            ...
            "SET_SECURE_5": "Clé de site cf-turnstile pour la page de connexion",
            "SET_SECURE_5_PH": "Laisser vide pour désactiver la fonctionnalité",
            "SET_SECURE_6": "Clé secrète cf-turnstile pour la page de connexion",
            "SET_SECURE_6_PH": "Laisser vide pour désactiver la fonctionnalité",
            ...
            "PASSKEY_DELETE_CONFIRM": "Êtes-vous sûr de vouloir supprimer l'appareil Passkey {} ? Vous ne pourrez plus utiliser cet appareil pour vous connecter après la suppression",
            ...
            "PASSKEY_TIP_BROWSERS": "Fonctionne au mieux sur les navigateurs modernes prenant en charge WebAuthn",
            "PASSKEY_TIP_PLATFORM_AUTHENTICATOR": "Certaines plateformes ne prennent en charge que les authentificateurs de plateforme (ex. empreinte/Face ID)",
            "PASSKEY_TIP_FALLBACK_PASSWORD": "En cas d’incompatibilité, vous pouvez toujours vous connecter avec identifiant et mot de passe",
            "PASSKEY_TIP_LOST_REMOVE": "En cas de perte de l’appareil, veuillez supprimer rapidement la Passkey correspondante",
            "DELETE": "Delete",
            "DELETING": "Deleting...",
