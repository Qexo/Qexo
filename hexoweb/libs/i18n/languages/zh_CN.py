...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "API_VERIFY_FAILED": "API 鉴权失败, 访问 IP: {}",
            "AUTH_FAILED": "鉴权错误！",
            "AUTHOR": "作者",
            "AUTO_PROVIDER_FAILED": "自动生成 PROVIDER 错误，请检查配置并提交",
            "BACKUP": "备份文件",
            ...
            "ERROR": "错误",
            "ERROR_GETTING_PROVIDER": "获取 PROVIDER 时出错",
            ...
            "EXCERPT_CHATGPT_API_KEY": "ChatGPT API 密钥",
            "EXCERPT_CHATGPT_API_KEY_PH": "请输入您的 ChatGPT API 密钥",
            ...
            "EXCERPT_CHATGPT_API_PH": "请输入 ChatGPT API 的 URL",
            "EXPORT": "导出",
            "FIND_INDEX_FAILED": "'更新失败: 未找到 Index 目录",
            "FIND_INDEX_SUCCESS": "找到 Index 目录",
            "FIND_UPDATE_INDEX": "解压完成, 寻找 Index 目录",
            "FINISH": "完成",
            "FIXING": "尝试修复中...请耐心等待",
            ...
            "FORCE_MSG": "确定要强制提交吗？",
            "FORCE_SUBMIT": "强制提交",
            "FRONT_MATTER_GET_ERROR": "FrontMatter 解析失败: {}",
            ...
            "HEXO_THEME": "\n检测到主题目录",
            "HEXO_THEME_FAILED": "\n未检测到主题目录",
            "HEXO_TOKEN_FAILED": "远程连接错误!请检查 Token",
            "HEXO_VERSION": "检测到 Hexo 版本: {}",
            "HEXO_VERSION_FAILED": "未检测到 Hexo",
            "HOME": "主页",
            "ICON": "图标",
            "ID_CODE": "识别代号",
            "IMAGE": "图片",
            ...
            "INIT": "初始化",
            "INIT_LANGUAGE_INVALID": "语言选择无效，请重新选择",
            "INIT_2_1": "API 密钥",
            "INIT_2_1_PH": "留空即自动生成",
            "INIT_2_2": "用户名",
            "INIT_2_2_PH": "设置用户名",
            ...
            "PROVIDER_VERIFY_SUCCESS": "Provider 校验结果: {}",
            "PUBLISHED": "已发布",
            ...
            "SET_SECURE_5": "登录页 cf-turnstile站点密钥",
            "SET_SECURE_5_PH": "留空即关闭该功能",
            "SET_SECURE_6": "登录页 cf-turnstile密钥",
            "SET_SECURE_6_PH": "留空即关闭该功能",
            "SET_STATISTICS": "统计配置",
            "SET_STATISTICS_1": "启用统计 API",
            ...
            "START_VERCEL_UPDATE": "开始更新, 使用 Vercel 方案",
            "STATUS": "状态",
            "STILL_IMPORT": "仍然继续",
            "SUBMIT": "提交",
            "SUPPORT": "支持",
            ...
            "WARN_WEBHOOK": "确定要自动创建 Webhook 事件吗？这会清除您原仓库的所有 Webhook 事件",
            "WEBHOOK_APIKEY_EXISTS": "APIKEY 已存在，请先删除再生成",
            "WEBHOOK_CREATE_SUCCESS": "Webhook 创建成功！",
            "WEBHOOK_NOT_SUPPORT": "平台不支持 Webhook 或发生错误",
            "WELCOME": "欢迎",
            "WIKI_LABEL": "查看文档",
            # Passkey / WebAuthn 相关标签
            "PASSKEY_MANAGER": "密钥管理",
            "PASSKEY_MANAGER_DESC": "管理您的 Passkey 设备，用于无密码认证",
            "MANAGE_PASSKEYS": "通行密钥",
            "PASSKEY_REGISTER": "注册新设备",
            "PASSKEY_REGISTER_DESC": "注册您的生物识别设备或安全密钥作为 Passkey",
            "PASSKEY_ADD_DEVICE": "添加设备",
            "PASSKEY_BACKUP_CODES": "备用码",
            "PASSKEY_BACKUP_CODES_DESC": "生成一次性备用码，在丧失所有 Passkey 设备时使用",
            "PASSKEY_GENERATE_BACKUP": "生成备用码",
            "PASSKEY_REGISTERED_DEVICES": "已注册的设备",
            "PASSKEY_DEVICE_NAME": "设备名称",
            "PASSKEY_CREATED_AT": "创建时间",
            "PASSKEY_LAST_USED": "最后使用",
            "PASSKEY_TYPE": "类型",
            "PASSKEY_NO_DEVICES": "暂无已注册的 Passkey 设备",
            "PASSKEY_DELETE_DEVICE": "删除设备",
            "PASSKEY_DELETE_CONFIRM": "确定要删除 Passkey 设备 {} 吗？删除后您将无法使用该设备登录",
            "PASSKEY_DEVICE_DELETED": "用户 {} 删除了 Passkey 设备 {}",
            "PASSKEY_DEVICE_ID_REQUIRED": "设备 ID 不能为空",
            "PASSKEY_DEVICE_NOT_FOUND": "设备不存在或不属于您",
            "PASSKEY_LOGIN": "使用 Passkey 登录",
            "PASSKEY_LOAD_FAILED": "加载设备列表失败",
            "PASSKEY_NEVER": "未使用",
            "PASSKEY_UNKNOWN": "未知",
            "PASSKEY_SAVE_BACKUP_CODES": "请妥善保管备用码",
            "PASSKEY_BACKUP_WARNING": "这些备用码是一次性的，请将其保存在安全的地方。如果丧失所有 Passkey 设备，可以使用这些码进行恢复",
            "PASSKEY_COPY_CODES": "复制备用码",
            "PASSKEY_DOWNLOAD_CODES": "下载备用码",
            "PASSKEY_CODES_COPIED": "备用码已复制到剪贴板",
            "PASSKEY_COPY_FAILED": "复制失败，请手动复制",
            "PASSKEY_CODES_DOWNLOADED": "备用码已下载",
            "PASSKEY_BACKUP_CODES_GENERATED": "备用码已生成",
            "PASSKEY_BACKUP_GENERATION_FAILED": "备用码生成失败",
            "PASSKEY_REGISTRATION_STARTING": "正在启动 Passkey 注册流程...",
            "PASSKEY_REGISTER_SUCCESS": "Passkey 注册成功！",
            "PASSKEY_REGISTRATION_FAILED": "Passkey 注册失败",
            "PASSKEY_TIP_BROWSERS": "在支持 WebAuthn 的现代浏览器上使用效果最佳",
            "PASSKEY_TIP_PLATFORM_AUTHENTICATOR": "部分平台仅支持平台认证器（如指纹/面容识别）",
            "PASSKEY_TIP_FALLBACK_PASSWORD": "不兼容时仍可使用账号密码登录",
            "PASSKEY_TIP_LOST_REMOVE": "如果设备遗失，请尽快移除对应的 Passkey 设备",
            "DELETE": "删除",
            "DELETING": "删除中...",
            "GENERATING": "生成中...",
            "GET_SUCCESS": "获取成功",
