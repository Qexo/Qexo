...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "WEBHOOK_APIKEY_EXISTS": "APIKEY已存在，请先删除再生成",
            "WEBHOOK_CREATE_SUCCESS": "Webhook创建成功！",
            "WEBHOOK_NOT_SUPPORT": "平台不支持Webhook或发生错误",
            "WELCOME": "欢迎",
            "WIKI_LABEL": "查看文档",
            # Passkey / WebAuthn 相关标签
            "PASSKEY_MANAGER": "密钥管理",
            "PASSKEY_MANAGER_DESC": "管理您的Passkey设备，用于无密码认证",
            "MANAGE_PASSKEYS": "通行密钥",
            "PASSKEY_REGISTER": "注册新设备",
            "PASSKEY_REGISTER_DESC": "注册您的生物识别设备或安全密钥作为Passkey",
            "PASSKEY_ADD_DEVICE": "添加设备",
            "PASSKEY_BACKUP_CODES": "备用码",
            "PASSKEY_BACKUP_CODES_DESC": "生成一次性备用码，在丧失所有Passkey设备时使用",
            ...
            "PASSKEY_TYPE": "类型",
            "PASSKEY_NO_DEVICES": "暂无已注册的Passkey设备",
            "PASSKEY_DELETE_DEVICE": "删除设备",
            "PASSKEY_DELETE_CONFIRM": "确定要删除Passkey设备 {} 吗？删除后您将无法使用该设备登录",
            "PASSKEY_DEVICE_DELETED": "用户 {} 删除了Passkey设备 {}",
            "PASSKEY_DEVICE_ID_REQUIRED": "设备ID不能为空",
            "PASSKEY_DEVICE_NOT_FOUND": "设备不存在或不属于您",
            "PASSKEY_LOGIN": "使用Passkey登录",
            "PASSKEY_LOAD_FAILED": "加载设备列表失败",
            "PASSKEY_NEVER": "未使用",
            "PASSKEY_UNKNOWN": "未知",
            "PASSKEY_SAVE_BACKUP_CODES": "请妥善保管备用码",
            "PASSKEY_BACKUP_WARNING": "这些备用码是一次性的，请将其保存在安全的地方。如果丧失所有Passkey设备，可以使用这些码进行恢复",
            ...
            "PASSKEY_REGISTRATION_STARTING": "正在启动Passkey注册流程...",
            "PASSKEY_REGISTER_SUCCESS": "Passkey注册成功！",
