...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "API_VERIFY_FAILED": "API 鑒權失敗, 訪問 IP: {}",
            "AUTH_FAILED": "鑒權錯誤！",
            "AUTHOR": "作者",
            "AUTO_PROVIDER_FAILED": "自動生成 PROVIDER 錯誤，請檢查配置並提交",
            "BACKUP": "備份文件",
            ...
            "ERROR": "錯誤",
            "ERROR_GETTING_PROVIDER": "獲取 PROVIDER 時出錯",
            ...
            "EXCERPT_CHATGPT_API_KEY": "ChatGPT API 密鑰",
            "EXCERPT_CHATGPT_API_KEY_PH": "請輸入您的 ChatGPT API 密鑰",
            "EXCERPT_CHATGPT_LENGTH": "發送長度",
            "EXCERPT_CHATGPT_LENGTH_PH": "發送到服務端的內容長度",
            "EXCERPT_CHATGPT_MODEL": "模型選擇",
            "EXCERPT_CHATGPT_MODEL_PH": "例如：text-davinci-003",
            "EXCERPT_CHATGPT_API": "ChatGPT API URL",
            "EXCERPT_CHATGPT_API_PH": "請輸入 ChatGPT API 的 URL",
            "EXPORT": "導出",
            "FIND_INDEX_FAILED": "'更新失敗: 未找到 Index 目錄",
            "FIND_INDEX_SUCCESS": "找到 Index 目錄",
            "FIND_UPDATE_INDEX": "解壓完成, 尋找 Index 目錄",
            "FINISH": "完成",
            "FIXING": "嘗試修復中...請耐心等待",
            ...
            "FORCE_MSG": "確定要強制提交嗎？",
            "FORCE_SUBMIT": "強制提交",
            "FRONT_MATTER_GET_ERROR": "FrontMatter 解析失敗: {}",
            ...
            "HEXO_THEME": "\n檢測到主題目錄",
            "HEXO_THEME_FAILED": "\n未檢測到主題目錄",
            "HEXO_TOKEN_FAILED": "遠程連接錯誤!請檢查 Token",
            "HEXO_VERSION": "檢測到 Hexo 版本: {}",
            "HEXO_VERSION_FAILED": "未檢測到 Hexo",
            "HOME": "主頁",
            "ICON": "圖標",
            "ID_CODE": "識別代號",
            "IMAGE": "圖片",
            ...
            "INIT": "初始化",
            "INIT_LANGUAGE_INVALID": "語言選擇無效，請重新選擇",
            "INIT_2_1": "API 密鑰",
            "INIT_2_1_PH": "留空即自動生成",
            "INIT_2_2": "用戶名",
            "INIT_2_2_PH": "設置用戶名",
            ...
            "PROVIDER_VERIFY_SUCCESS": "Provider 校驗結果: {}",
            "PUBLISHED": "已發布",
            ...
            "SET_SECURE_5": "登錄頁 cf-turnstile站點密鑰",
            "SET_SECURE_5_PH": "留空即關閉該功能",
            "SET_SECURE_6": "登錄頁 cf-turnstile密鑰",
            "SET_SECURE_6_PH": "留空即關閉該功能",
            "SET_STATISTICS": "統計配置",
            "SET_STATISTICS_1": "啟用統計 API",
            ...
            "START_VERCEL_UPDATE": "開始更新, 使用 Vercel 方案",
            "STATUS": "狀態",
            "STILL_IMPORT": "仍然繼續",
            "SUBMIT": "提交",
            "SUPPORT": "支持",
            ...
            "WARN_WEBHOOK": "確定要自動創建 Webhook 事件嗎？這會清除您原倉庫的所有 Webhook 事件",
            "WEBHOOK_APIKEY_EXISTS": "APIKEY 已存在！",
            "WEBHOOK_CREATE_SUCCESS": "Webhook 創建成功！",
            "WEBHOOK_NOT_SUPPORT": "該 Provider 不支持 Webhook！",
            "WELCOME": "歡迎",
            "WIKI_LABEL": "查看文檔",
            "GET_SUCCESS": "獲取成功",
            # Passkey / WebAuthn 相關標籤
            "PASSKEY_MANAGER": "Passkey 管理",
            "PASSKEY_MANAGER_DESC": "管理您的 Passkey 設備，用於無密碼認證",
            "MANAGE_PASSKEYS": "通行密鑰",
            "PASSKEY_REGISTER": "註冊新設備",
            "PASSKEY_REGISTER_DESC": "註冊您的生物識別設備或安全密鑰作為 Passkey",
            "PASSKEY_ADD_DEVICE": "添加設備",
            "PASSKEY_BACKUP_CODES": "備用碼",
            "PASSKEY_BACKUP_CODES_DESC": "生成一次性備用碼，在喪失所有 Passkey 設備時使用",
            "PASSKEY_GENERATE_BACKUP": "生成備用碼",
            "PASSKEY_REGISTERED_DEVICES": "已註冊的設備",
            "PASSKEY_DEVICE_NAME": "設備名稱",
            "PASSKEY_CREATED_AT": "創建時間",
            "PASSKEY_LAST_USED": "最後使用",
            "PASSKEY_TYPE": "類型",
            "PASSKEY_NO_DEVICES": "暫無已註冊的 Passkey 設備",
            "PASSKEY_DELETE_DEVICE": "刪除設備",
            "PASSKEY_DELETE_CONFIRM": "確定要刪除 Passkey 設備 {} 嗎？刪除後您將無法使用該設備登入",
            "PASSKEY_DEVICE_DELETED": "用戶 {} 刪除了 Passkey 設備 {}",
            "PASSKEY_DEVICE_ID_REQUIRED": "設備 ID 不能為空",
            "PASSKEY_DEVICE_NOT_FOUND": "設備不存在或不屬於您",
            "PASSKEY_LOGIN": "使用 Passkey 登入",
            "PASSKEY_LOAD_FAILED": "加載設備列表失敗",
            "PASSKEY_NEVER": "未使用",
            "PASSKEY_UNKNOWN": "未知",
            "PASSKEY_SAVE_BACKUP_CODES": "請妥善保管備用碼",
            "PASSKEY_BACKUP_WARNING": "這些備用碼是一次性的，請將其保存在安全的地方。如果喪失所有 Passkey 設備，可以使用這些碼進行恢復",
            "PASSKEY_COPY_CODES": "複製備用碼",
            "PASSKEY_DOWNLOAD_CODES": "下載備用碼",
            "PASSKEY_CODES_COPIED": "備用碼已複製到剪貼板",
            "PASSKEY_COPY_FAILED": "複製失敗，請手動複製",
            "PASSKEY_CODES_DOWNLOADED": "備用碼已下載",
            "PASSKEY_BACKUP_CODES_GENERATED": "備用碼已生成",
            "PASSKEY_BACKUP_GENERATION_FAILED": "備用碼生成失敗",
            "PASSKEY_REGISTRATION_STARTING": "正在啟動 Passkey 註冊流程...",
            "PASSKEY_REGISTER_SUCCESS": "Passkey 註冊成功！",
            "PASSKEY_REGISTRATION_FAILED": "Passkey 註冊失敗",
            "PASSKEY_TIP_BROWSERS": "在支援 WebAuthn 的現代瀏覽器上使用效果最佳",
            "PASSKEY_TIP_PLATFORM_AUTHENTICATOR": "部分平台僅支援平台驗證器（如指紋/臉部辨識）",
            "PASSKEY_TIP_FALLBACK_PASSWORD": "不相容時仍可使用帳號密碼登入",
            "PASSKEY_TIP_LOST_REMOVE": "若裝置遺失，請儘速移除對應的 Passkey 裝置",
            "DELETE": "刪除",
            "DELETING": "刪除中...",
            "GENERATING": "生成中...",
            "ACTION": "操作",
