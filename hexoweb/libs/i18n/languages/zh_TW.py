...
class Main(Language):
    ...
    default = {
        ...
        "data": {
            ...
            "PASSKEY_MANAGER": "Passkey管理",
            "PASSKEY_MANAGER_DESC": "管理您的Passkey設備，用於無密碼認證",
            "MANAGE_PASSKEYS": "通行密鑰",
            "PASSKEY_REGISTER": "註冊新設備",
            "PASSKEY_REGISTER_DESC": "註冊您的生物識別設備或安全密鑰作為Passkey",
            "PASSKEY_ADD_DEVICE": "添加設備",
            "PASSKEY_BACKUP_CODES": "備用碼",
            "PASSKEY_BACKUP_CODES_DESC": "生成一次性備用碼，在喪失所有Passkey設備時使用",
            ...
            "PASSKEY_TYPE": "類型",
            "PASSKEY_NO_DEVICES": "暫無已註冊的Passkey設備",
            "PASSKEY_DELETE_DEVICE": "刪除設備",
            "PASSKEY_DELETE_CONFIRM": "確定要刪除Passkey設備 {} 嗎？刪除後您將無法使用該設備登入",
            "PASSKEY_DEVICE_DELETED": "用戶 {} 刪除了Passkey設備 {}",
            "PASSKEY_DEVICE_ID_REQUIRED": "設備ID不能為空",
            "PASSKEY_DEVICE_NOT_FOUND": "設備不存在或不屬於您",
            "PASSKEY_LOGIN": "使用Passkey登入",
            "PASSKEY_LOAD_FAILED": "加載設備列表失敗",
            "PASSKEY_NEVER": "未使用",
            "PASSKEY_UNKNOWN": "未知",
            "PASSKEY_SAVE_BACKUP_CODES": "請妥善保管備用碼",
            "PASSKEY_BACKUP_WARNING": "這些備用碼是一次性的，請將其保存在安全的地方。如果喪失所有Passkey設備，可以使用這些碼進行恢復",
            ...
            "PASSKEY_REGISTRATION_STARTING": "正在啟動Passkey註冊流程...",
            "PASSKEY_REGISTER_SUCCESS": "Passkey註冊成功！",
            "PASSKEY_REGISTRATION_FAILED": "Passkey註冊失敗",
